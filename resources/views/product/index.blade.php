...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Produt Management</h2>
                            ...
                            <table class="table table-bordered table-md">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/img/products/' . $product->thumbnail) }}" alt="" style="height: 3rem;" class="rounded mx-2">
                                            {{ $product->name }}
                                        </td>
                                        <td>{{ '$' . $product->price }}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ route('product.edit', $product->id) }}" class="btn btn-sm btn-info btn-icon "><i class="fas fa-edit"></i>
                                                    Edit</a>
